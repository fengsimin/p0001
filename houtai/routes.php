...
#==== GET trash/one/:id/:column

$o['GET']['trash/one/:id/:column']=array (
	  'class_name' => 'Trash',
	  'method_name' => 'getOne',
	  'arguments' => 
	  array (
...
#==== GET trash/error/:message

$o['GET']['trash/error/:message']=array (
	  'class_name' => 'Trash',
	  'method_name' => 'error',
	  'arguments' => 
	  array (
...
#==== GET trash/error/:message/:data

$o['GET']['trash/error/:message/:data']=array (
	  'class_name' => 'Trash',
	  'method_name' => 'error',
	  'arguments' => 
	  array (
...
#==== GET trash/success/:message

$o['GET']['trash/success/:message']=array (
	  'class_name' => 'Trash',
	  'method_name' => 'success',
	  'arguments' => 
	  array (
...
#==== GET trash/success/:message/:data

$o['GET']['trash/success/:message/:data']=array (
	  'class_name' => 'Trash',
	  'method_name' => 'success',
	  'arguments' => 
	  array (
...
#==== POST trash/update/:id

$o['POST']['trash/update/:id']=array (
	  'class_name' => 'Trash',
	  'method_name' => 'postUpdate',
	  'arguments' => 
	  array (
...
#==== POST trash/removeimage

$o['POST']['trash/removeimage']=array (
	  'class_name' => 'Trash',
	  'method_name' => 'postRemoveImage',
	  'arguments' => 
	  array (
...
#==== POST trash/removeimage/:id

$o['POST']['trash/removeimage/:id']=array (
	  'class_name' => 'Trash',
	  'method_name' => 'postRemoveImage',
	  'arguments' => 
	  array (
...
#==== POST trash/removeimage/:id/:prefix

$o['POST']['trash/removeimage/:id/:prefix']=array (
	  'class_name' => 'Trash',
	  'method_name' => 'postRemoveImage',
	  'arguments' => 
	  array (
...
#==== POST trash/removeimage2

$o['POST']['trash/removeimage2']=array (
	  'class_name' => 'Trash',
	  'method_name' => 'postRemoveImage2',
	  'arguments' => 
	  array (
...
#==== POST trash/removefile2

$o['POST']['trash/removefile2']=array (
	  'class_name' => 'Trash',
	  'method_name' => 'postRemoveFile2',
	  'arguments' => 
	  array (
